...
$('document').ready(function(){
		...
		$(window).resize(function(){
				 vw = $(window).width()/2;
				 var balloonGap = Math.min(100, Math.max(58, ($(window).width() - 58) / 6));
				 var balloonStart = vw - (balloonGap * 3);
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7').stop();
				$('#b11').animate({top:240, left: balloonStart},500);
				$('#b22').animate({top:240, left: balloonStart + balloonGap},500);
				$('#b33').animate({top:240, left: balloonStart + balloonGap * 2},500);
				$('#b44').animate({top:240, left: balloonStart + balloonGap * 3},500);
				$('#b55').animate({top:240, left: balloonStart + balloonGap * 4},500);
				$('#b66').animate({top:240, left: balloonStart + balloonGap * 5},500);
				$('#b77').animate({top:240, left: balloonStart + balloonGap * 6},500);
		});
